...
<h2>Dataset</h2>
The dataset used in this project is called Earthquake_data.csv and it contains information about earthquakes that have occurred with a magnitude of 3.0 or greater.
